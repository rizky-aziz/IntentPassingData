...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public Button btnMoveWithDataObject;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMoveWithDataObject = (Button)findViewById(R.id.btn_move_activity_object);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Rizki Aziz Husni");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 24);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person person = new Person();
                person.setName("Rizki Aziz Husni");
                person.setAge(24);
                person.setEmail("rizkyaziz2002@gmail.com");
                ...
                break;
            case R.id.btn_dial_number:String phoneNumber = "0898972479123";
